...
contextBridge.exposeInMainWorld('overlay', {
  ...
  playSlot: (opts: { bet: number; lines: number }): Promise<unknown> => ipcRenderer.invoke('slot-play', opts),
  lotteryState: (): Promise<unknown> => ipcRenderer.invoke('lottery-state'),
  lotteryBuy: (): Promise<unknown> => ipcRenderer.invoke('lottery-buy'),
  lotteryClaim: (ticketId: string): Promise<unknown> => ipcRenderer.invoke('lottery-claim', ticketId),
